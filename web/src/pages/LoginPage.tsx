...
import { adminLogin, getSession, requestOtp, setSession, verifyOtp } from "../api";
...
export default function LoginPage() {
  ...
  return (
    <div className="panel">
      ...
      <p className="muted">{asAdmin ? "Admin login (no OTP)." : "Request an OTP, then verify to login."}</p>
